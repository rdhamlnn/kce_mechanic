    ...
    <form method="post">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <textarea name="keluhan_kerusakan" id="keluhan_kerusakan"></textarea>
        </div>
        <div class="form-group">
          <label for="penyebab_kerusakan">Penyebab Kerusakan</label>
          <textarea name="penyebab_kerusakan" id="penyebab_kerusakan"></textarea>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group">
          <label for="tgl_mulai_reparasi">Tgl Mulai Reparasi</label>
          <input type="date" name="tgl_mulai_reparasi" id="tgl_mulai_reparasi">
        </div>
        <div class="form-group">
          <label for="tgl_selesai_reparasi">Tgl Selesai Reparasi</label>
          <input type="date" name="tgl_selesai_reparasi" id="tgl_selesai_reparasi">
        </div>
      </div>
      <div class="form-group">
        <label for="tindakan_perbaikan">Tindakan Perbaikan</label>
        <textarea name="tindakan_perbaikan" id="tindakan_perbaikan"></textarea>
      </div>
